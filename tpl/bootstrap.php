...
?>
		...
		<!-- icon -->
		<link rel="apple-touch-icon" href="<?php echo I18n::encode($BASEPATH); ?>img/DreamsEngine-04.png" sizes="180x180" />
		<link rel="icon" type="image/png" href="img/DreamsEngine-04.png" sizes="32x32" />
		<link rel="icon" type="image/png" href="img/DreamsEngine-04.png" sizes="16x16" />
		...
		<link rel="shortcut icon" href="img/DreamsEngine-04.png">
		...
		<meta name="twitter:image" content="<?php echo I18n::encode($BASEPATH); ?>img/DreamsEngine-04.png" />
		...
		<meta property="og:image" content="<?php echo I18n::encode($BASEPATH); ?>img/DreamsEngine-04.png" />
			...
			<footer class="container">
				<div class="row">
					...
					<p id="aboutbox" class="col-md-6 col-xs-12">
						<?php echo I18n::_('%s is a minimalist, open source online pastebin where the server has zero knowledge of pasted data. Data is encrypted/decrypted using 256 bits AES.', I18n::_($NAME)), ' ', $INFO, PHP_EOL; ?>
					</p>
				</div>
			</footer>
		</main>
